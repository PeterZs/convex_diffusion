...
xlabel('Time [ms]');
ylabel('Moment [rad/m]');
legend(['\sigma_{sym}=' num2str(std(sym.M(1,:)),'%1.2e')], ...
	   ['\sigma_{cvx} =' num2str(std(cvx.M(1,:)),'%1.2e')], ...
	   'Location','southwest');
set(gca, 'FontSize', 16);
...
legend(['\sigma_{sym}=' num2str(std(sym.M(2,:)),'%1.2e')], ...
	   ['\sigma_{cvx} =' num2str(std(cvx.M(2,:)),'%1.2e')], ...
	   'Location','southwest');
set(gca, 'FontSize', 16);
...
legend(['\sigma_{sym}=' num2str(std(sym.M(3,:)),'%1.2e')], ...
	   ['\sigma_{cvx} =' num2str(std(cvx.M(3,:)),'%1.2e')], ...
	   'Location','southwest');
set(gca, 'FontSize', 16);