...
mText = ['$m_{sym} = $' num2str(sym.m1*1e3,'%1.2f') '$ \frac{mT\cdot s}{m}$'];
text(sym.tInv*1e3, sym.phiCC(sym.nInv)-0.05*yr, mText, ...
	'HorizontalAlignment','center', 'Interpreter', 'latex', 'FontSize', 16)
mText = ['$m_{asym} = $' num2str(asym.m1*1e3,'%1.2f') '$ \frac{mT\cdot s}{m}$'];
text(asym.tInv*1e3, asym.phiCC(asym.nInv)-0.05*yr, mText, ...
	'HorizontalAlignment','center', 'Interpreter', 'latex', 'FontSize', 16)
mText = ['$m_{coco} = $' num2str(coco.m1*1e3,'%1.2f') '$ \frac{mT\cdot s}{m}$'];
